...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProccesor
    {
        ...
        public static void SaveRoundsToFile(this TournamentModel model, string matchupFile, string matchuEntryFile)
        {
            ...
            foreach (List<MatchupModel> round in model.Rounds)
            {
                foreach (MatchupModel matchup in round)
                {
                    ...
                    // Get the top id, add 1
                    // store id
                    // save the matchup record

                    matchup.SaveMatchupToFile(matchupFile, matchuEntryFile);
                }
            }
        }
        public static List<MatchupEntryModel> ConvertToMatchupEntriesModel(this List<string> input)
        {
        ...
        private static List<MatchupEntryModel> ConvertStringToMatchupEntryModels(string input)   
        {
            ...
            List<MatchupEntryModel> output = new List<MatchupEntryModel>();
            List<MatchupEntryModel> entries = GlobalConfig.MatchupFile.FullFilePath().loadFile().ConvertToMatchupEntriesModel();
        ...
        {
            // id = 0, entries =1(piped), winner=2, matchupRounds=3
        ...
        {
            List<MatchupEntryModel> entries = GlobalConfig.MatchuEntryFile.FullFilePath().loadFile().ConvertToMatchupEntriesModel();
            ...
            File.WriteAllLines(GlobalConfig.MatchuEntryFile.FullFilePath(), lines);
        }
